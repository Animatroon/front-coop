    ...
    <div className={styles.myreq}>
        ...
        <div className={`${styles.myreq__inner} box`}>
            ...
            <div className={styles.sidebar}>
                <a className={styles.sidebar__title} href="#e"><img src={Personal.profile} alt="" /> Мой профиль</a>
                <div className={styles.sidebar__line}></div>
                <a className={styles.sidebar__title} href="#e"><img src={Personal.reqCreate} alt="" /> Создать новую заявку</a>
                <div className={styles.sidebar__line}></div>
