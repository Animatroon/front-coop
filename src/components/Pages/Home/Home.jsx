...
const NewsCard = ({img, title, day, month}) => {

  return (
    <a href="#news1" className="card" style={{backgroundImage: `url(${img})`}}>
    ...
    return (
      <div className='Home'>
          ...
          <div className="main__item">
            <h3 className="main__suptitle">Республиканское общественное объединение</h3>
                <h1 className="main__title">Казахстанское Общество Правообладателей</h1>
                <ButtonGroup>
                  <Button className='me-4 btn-cons' variant="light">
      ...
      <section className="function">
        <h1 className="title">Функции</h1>
        <h3 className="subtitle ">РОО “Казахстанское Общество Правообладателей”</h3>
        <Container>
          <Row>
          <Col>
            <div className="function-card">
              ...
              <div className="function__content">
                <h4 className="function-card__title">Lorem ipsum</h4>
                <p className="function-card__text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna  aliqua. Erat velit scelerisque in dictum non consectetur a erat.</p>
              </div>
            </div>
      ...
      <section className='about'>
        ...
        <div className='about__inner'>
          ...
          <div className="about__content">
            <h1 className="about__title">РОО <br /> “КОП”</h1>
            <p className="about__text"> Республиканское общественное объединение "Казахстанское Общество Правообладателей" является организацией по управлению имущественными правами авторов и обладателей смежных прав на коллективной основе.</p>
            <a className='about__btn' href="#r">О компании</a>
      ...
      <section className="box news">
        <div className="news__header">
          <div className="news__titles">
            <h3 className="suptitle news__suptitle">ПОСЛЕДНИЕ СОБЫТИЯ</h3>
            <h1 className="title news__title">НОВОСТИ</h1>
          </div> 
            <a href="#re" className="news__btn">подробнее</a>
        </div>
      ...
      <section className="contacts">
        ...
        <div className='contacts__inner'>
          <Col><img className='contacts__img' src={Main.map} alt="contacts" style={{width: `${mapWidth}px`}} /></Col>
          <Col>
              <h3 className="suptitle contacts__suptitle">СПОСОБЫ СВЯЗИ С НАМИ</h3>
              <h2 className="title contacts__title">Наши контакты</h2>
      ...
      <section className='form'>
        <div className="form__item">
          <h3 className="suptitle form__suptitle">Остались вопросы?</h3>
          <h2 className="title form__title">Получите <br /> консультацию</h2>
          <p className="fields">*ОБЯЗАТЕЛЬНЫЕ ПОЛЯ</p>
          <Form>
            <Form.Group className="mb-3" controlId='formBasicName'>
              <Form.Label>ФИО*</Form.Label>
              <Form.Control required type="email" placeholder='ФИО'></Form.Control>
            </Form.Group>
            <Form.Group className="mb-3" controlId='formBasicPhone'>
              <Form.Label>Номер телефона*</Form.Label>
              <Form.Control required type="phone" placeholder='Номер телефона'></Form.Control>
            </Form.Group>
        ...
        <div className="form__item">
          <img src={Main.contacts} style={{width: `${contactWidth}px`}} alt="contacts" />
        </div>
